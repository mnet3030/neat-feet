...
public class Userrr implements com.imagine.neatfeat.model.dal.entity.Entity {
    ...
    public Userrr(UUID id, UserRoles userRoles, String email, String password, String name, Date birthdate, boolean gender, int creditLimit) {
        this.id = id;
    ...
    public Userrr(UUID id, Country country, UserRoles userRoles, String email, String password, String name, Date birthdate, boolean gender, int creditLimit, String job, String address, String phone, String photoUrl, Set<ShoppingCart> shoppingCarts, Set<UserVisitProducts> userVisitProductses, Set<UserOrders> userOrderses, Set<WishingList> wishingLists) {
        this.id = id;
    ...
    @OneToMany(fetch=FetchType.LAZY, mappedBy= "getUserrr")
