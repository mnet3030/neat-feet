...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/view/customer/html/css/about.css" type="text/css" media="screen" property="" />
		...
		<div class="shop_inner_inf">
			...
			<div class="inner_section_w3ls">
				<div class="col-md-6 news-left">
					<img src="${pageContext.request.contextPath}/view/customer/html/images/ab.jpg" alt=" " class="img-responsive">
				</div>
